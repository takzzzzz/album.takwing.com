	...
	prty = { 
        ...
        Setup: function(gDiv, settings) {
            ...
            flickr.photosets.getPhotos({
                ...
                extras: 'url_l, url_q, owner_name, views, date_upload'
        ...
        buildThumb: function() { 
            ...
            for(var i=0; i < prty.photoDetails.length; i++){
                ...
                thisItem = prty.galleryDiv.append("<li id="+i+"><a href='"+img.url_l+"'><img src='"+img.url_q+"' alt='"+img.title+"' /><div class='bg'></div><div class='content'></div><i class='show' data-href='"+img.url_l+"' data-photoid='"+img.id+"'>VIEW IT</i></a></li>").find('li .content').last();
        ...
        loadCnt: function(settings){
            ...
            var img = new Image();
                img.onload = function(){
                    ...
                    //Resize
                    prty.resizeViewBox(settings, 'q');                
                    //Hide the preloader
                    prty.loader.fadeOut(settings.Speed/2);  
                }; 
                img.src = prty.photoDetails[prty.activeEl].url_l;
